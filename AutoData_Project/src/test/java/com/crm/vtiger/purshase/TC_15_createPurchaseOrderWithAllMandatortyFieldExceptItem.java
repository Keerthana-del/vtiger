...
public class TC_15_createPurchaseOrderWithAllMandatortyFieldExceptItem extends BaseClass{
	WebDriverUtility wUtil=new WebDriverUtility();
	@Test
	public void createPurchaseWithDownwardSymbol() throws InterruptedException{
		...
		driver.findElement(By.xpath("//img[@title='Products']")).click();
		driver.findElement(By.xpath("//input[@name='listPrice1']")).sendKeys("577");
